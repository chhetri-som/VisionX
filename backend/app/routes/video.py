...
from app.schemas.responses import VideoAnalyzeResponse
...
async def analyze_video(
    ...
    try:
        ...
        # Single call to the classifier - it now handles everything including base64!
        avg_confidence, agg_reasoning, frame_results = video_classifier.classify_frames(frame_data_list)
        
        # Pass the results directly to the findings engine
